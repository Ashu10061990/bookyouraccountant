...
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- |
| `accountants`                      | read (⚠️ currently world-readable — an accepted risk in spec §18), create/update with anti-self-verification on `verified`/`examScore`/`rating`/`reviewsCount`                                                                                                                                                | Phase 3 follow-up                                    |
| `accountants/{uid}/kyc`            | read owner-or-admin, **write denied to every client**                                                                                                                                                                                                                                                         | Phase 3 follow-up, after KMS                         |
| `businesses`                       | read/create/update owner-only, `orgPanEncrypted` immutable                                                                                                                                                                                                                                                    | Phase 3 follow-up                                    |
...
| `adminActions`                     | admin read; write denied to all                                                                                                                                                                                                                                                                               | with §6.7 audit log                                  |
