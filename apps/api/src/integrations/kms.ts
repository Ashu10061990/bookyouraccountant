 ...
 *
 * It is also the seam the provider decision goes through. The database lives
 * on AWS (Atlas) but hosting may not, so "which KMS" is a real choice — and
 * one that does not need making today. Anything satisfying this interface
 * will drop in.
 */
