...
import { type AuthDeps, contextOf, requireAuth, requireRole } from "./auth.middleware.js";
...
describe("role is read from the database, never from the token", () => {
  // The attack this prevents: token claims are baked in for the token's whole life,
